...
UILIB_API __declspec(deprecated) LPSTR  AnsiToUtf8(LPCSTR  str, int len = -1);
UILIB_API __declspec(deprecated) LPSTR  AnsiStrDup(LPCSTR  str, int len = -1);

UILIB_API LPWSTR Utf8ToWide(LPCSTR  str, int len = -1);
UILIB_API __declspec(deprecated) LPSTR  Utf8ToAnsi(LPCSTR  str, int len = -1);
...
UILIB_API __declspec(deprecated) LPWSTR StringAllocW(size_t len);
UILIB_API __declspec(deprecated) LPSTR  StringAllocA(size_t len);
UILIB_API void   StringFree(LPWSTR str);
UILIB_API void   StringFree(LPSTR str);
