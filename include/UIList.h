...
public:
    ...
    virtual bool SelectItem(int iIndex, bool bTakeFocus = false, bool bSendNofitied = true) = 0;
...
public:
    ...
    int GetCurSel() const;
    bool SelectItem(int iIndex, bool bTakeFocus = false, bool bSendNofitied = true);
	bool Activate();
