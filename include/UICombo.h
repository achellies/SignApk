...
public:
	...
	LPCTSTR GetHitText();
	void SetHitText(LPCTSTR pStrText);
	DWORD GetHitTextColor();
	void SetHitTextColor(DWORD dwColor);
	...
	virtual bool SelectItem(int iIndex, bool bTakeFocus = false, bool bSendNofitied = true);
	virtual bool Activate();
protected:
    CComboWnd* m_pWindow;
	CEditWndEx* m_pEditWnd;
	UINT m_uSelectRangeStart;
	...
	CStdString m_sHitText;
	DWORD m_dwHitTextColor;
